...
%global pkg_name diagnostic_remote_logging
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-diagnostic-remote-logging
Version:        4.4.7
Release:        1%{?dist}
...
%changelog
* Tue May 26 2026 Daan Wijffels <dwijffels@lely.com> - 4.4.7-1
- Autogenerated by Bloom

* Wed Apr 29 2026 Daan Wijffels <dwijffels@lely.com> - 4.4.6-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Daan Wijffels <dwijffels@lely.com> - 4.4.6-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Daan Wijffels <dwijffels@lely.com> - 4.4.6-1
- Autogenerated by Bloom
